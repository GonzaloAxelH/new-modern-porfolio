...
export default function Blog() {
  return (
    <Container showCircles title="Blog - Gonzalo Axel">
      <h1 className="dark:text-white">
        ...
        <span className="block max-w-2xl mx-auto mt-2 text-4xl font-bold leading-10 text-center sm:text-5xl">
          Contenido diario y util para usted
        </span>
      </h1>
      <div className="grid grid-cols-1 md:grid-cols-12 md:gap-8">
        <button className="col-span-8 space-y-2 text-left hover:cursor-pointer group">
          <div>
            <Image
              ...
              placeholder="blur"
              blurDataURL={recentArticles[0].coverImage}
              width={1200}
              height={684}
              layout="intrinsic"
              alt={"article cover"}
            ...
            <div className="">
              <div className="flex items-center mt-4 md:justify-start">
                <p className="m-0 text-lg font-semibold dark:text-slate-400">
                  Featured article
                </p>
                <svg
                  className="w-7 h-7"
              ...
              <h2 className="my-4 text-4xl dark:text-white">
                {recentArticles[0].title}
              </h2>
              <p className="dark:text-slate-400">{recentArticles[0].summary}</p>
            </div>
          </div>
        </button>
      ...
      <div className="relative my-12 overflow-x-auto">
        ...
        <ul className="flex w-full gap-6 py-8 overflow-x-auto snap-x">
          ...
          <div className="scroll-ml-6 snap-normal snap-start shrink-0"></div>
        </ul>
